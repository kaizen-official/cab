    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-[13px] text-text-secondary mt-1">
          Rides you&apos;ve joined or requested
        </p>
      </div>
      ...
      {loading ? (
        ...
        <Empty
          ...
          description="Search for rides and request a booking."
        />
      ) : (
        <>
          <div className="space-y-3">
            {result.items.map((booking, i) => (
              <motion.div
                key={booking.id}
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <Link
                    href={`/dashboard/rides/${booking.ride.id}`}
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 mt-2">
                      ...
                      <span className="text-[14px] text-accent-mint font-black">
                        &#8377;
                        {booking.ride.pricePerSeat * booking.seatsBooked}
                      </span>
                    </div>
                    <div className="text-[12px] text-text-tertiary mt-1.5 font-medium">
                      Driver: {booking.ride.creator.firstName}{" "}
                      {booking.ride.creator.lastName}
                    </div>
                  </Link>
